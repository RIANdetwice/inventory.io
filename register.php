            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <h2 class="fs-20 fw-bolder mb-4 text-center ">Register </h2>
                        ...
                        <form action="proces_register.php" method="post" class="w-100 mt-4 pt-2">
                            <div class="mb-4">
                                <input type="tel" name="username" class="form-control" placeholder="Username" required>
                            </div>
                            <div class="mb-4 generate-pass">
                                <div class="input-group field">
                                    <input type="password" class="form-control password" name="username" id="newPassword" placeholder="Password ">
